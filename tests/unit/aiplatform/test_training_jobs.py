...
_TEST_MACHINE_TYPE_TPU_V5E = test_constants.TrainingJobConstants._TEST_MACHINE_TYPE_TPU_V5E
...
_TEST_ACCELERATOR_TPU_TYPE = test_constants.TrainingJobConstants._TEST_ACCELERATOR_TPU_TYPE
...
class TestCustomTrainingJob:
    ...
    def test_training_job_tpu_v3_pod(
            self,
            mock_pipeline_service_create):
        aiplatform.init(
            project=_TEST_PROJECT,
